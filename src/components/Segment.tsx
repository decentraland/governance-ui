...
type SegmentProps = React.Props<HTMLScriptElement> &
...
export default React.memo(function Segment({ trackPage, ...props }: SegmentProps) {
  const segmentKey = config.get('SEGMENT_KEY', '')
  if (!segmentKey) {
